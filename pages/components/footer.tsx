        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid
            ...
            <Stack spacing={6}>
              ...
              <Text fontSize={'sm'}>
               Lawfully White Construction Ltd. :Copyright :Copy Claim
              </Text>
              <Stack direction={'row'} spacing={6}>
                <SocialButton label={'Facebook'} href={'https://www.facebook.com/LawfullyWhiteConstruction'}>
                  <FaFacebook />
                </SocialButton>
                <SocialButton label={'Twitter'} href={'https://twitter.com/LawfullyWhite'}>
                  <FaTwitter />
                </SocialButton>
                <SocialButton label={'LinkedIn'} href={'https://www.linkedin.com/company/lawfullywhiteconstruction'}>
                  <FaLinkedin />
                </SocialButton>
              </Stack>
            </Stack>
            <Stack align={'flex-start'}>
              ...
              <Link onClick={(e) => { e.preventDefault(), router.push('/about') }}>About us</Link>
              <Link onClick={(e) => { e.preventDefault(), router.push('/services') }}>Services</Link>
              <Link onClick={(e) => { e.preventDefault(), router.push('/reviews') }}>Reviews</Link>
              <Link onClick={(e) => { e.preventDefault(), router.push('/blog') }}>Blog</Link>
              <Link onClick={(e) => { e.preventDefault(), router.push('/contact') }}>Contact us</Link>
            </Stack>
            <Stack align={'flex-start'}>
              ...
              <Link href={'#'}>Book A Builder</Link>
              <Link href={'#'}>Check-A-Trade</Link>
            </Stack>
            <Stack align={'flex-start'}>
